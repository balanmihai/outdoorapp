          ...
          <ul className="space-y-3 mt-4">
            {chatMessages.map((msg, idx) => (
              <li key={idx} className="bg-gray-100 p-4 rounded-lg shadow-sm">
                <strong className="text-gray-900">{msg.sender}:</strong>{" "}
                {msg.text}
              </li>
            ))}
          </ul>
              ...
              <div>
                {trip.participants.some(
                  ...
                  <button
                    ...
                    className="w-full md:w-auto bg-red-800 text-white py-3 px-6 rounded-xl shadow-md hover:bg-red-700 transition-all"
                  >
                    Unjoin Trip
                  </button>
                ) : (
